...
class ObtenerRecetasUseCase:
    ...
    def execute(self, sort_by: str = 'nombre', filter_by: str = None, grupo_id: str = None, producto_id: str = None) -> list[Receta]:
        """Ejecuta la obtención de todas las recetas."""
        return self.repository.obtener_todos(sort_by=sort_by, filter_by=filter_by, grupo_id=grupo_id, producto_id=producto_id)
