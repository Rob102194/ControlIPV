...
const GrupoList = lazy(() => import('./views/grupos/GrupoList'));
const GrupoForm = lazy(() => import('./views/grupos/GrupoForm'));
...
const AppLayout = () => {
  ...
  return (
    <div className="d-flex flex-column vh-100">
      <Navbar bg={theme} variant={theme} expand="lg" className="border-bottom" sticky="top">
        <Container>
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/grupos", element: <GrupoList /> },
      { path: "/grupos/nuevo", element: <GrupoForm /> },
      { path: "/grupos/editar/:id", element: <GrupoForm /> },
    ],
  },
], {
  future: {
