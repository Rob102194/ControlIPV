...
const RecetaForm = () => {
  ...
  const [grupos, setGrupos] = useState([]); // Lista de grupos para los select
  ...
  useEffect(() => {
    const cargarDependencias = async () => {
      try {
        // Carga productos, áreas y grupos en paralelo
        const [productosRes, areasRes, gruposRes] = await Promise.all([
          productoApi.obtenerProductos(),
          areaApi.obtenerTodos(),
          grupoApi.obtenerTodos()
        ]);
